...
\titlespacing*{\subsubsection}{0pt}{1.3ex plus 5pt minus 2pt }{1.3em plus 5pt minus 2pt } % Отступы вокруг заголовка параграфа
\titlespacing*{\paragraph}{0pt}{1em plus 5pt minus 2pt }{1em plus 5pt minus 2pt } % Отступы вокруг заголовка параграфа
...
\setlength{\floatsep}{1em plus 4pt minus 2pt}     % между float'ами
\setlength{\textfloatsep}{2em plus 4pt minus 2pt} % между float'ами и текстом
\setlength{\intextsep}{2em plus 4pt minus 2pt}    % для float'ов внутри текста
