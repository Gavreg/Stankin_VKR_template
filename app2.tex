...
\begin{VKRlongtable}
	...
	\begin{longtable}{|l|c|c|c|}
		...
		%по непонятной мне причине, такое оформление длинных таблиц у нас запрещено		
		\if 0 
			...
			\textbf{Размер} &
			\textbf{ Соотн. сторон} & 
			\textbf{Кол-во пикселей} \\ 
			\hline \endfirsthead
			
			%Шапка продолжения таблицы
			\hline 
			\multicolumn{4}{|r|}{Начало на стр. \pageref{tbl:screensize}}  \\
			\hline \textbf{Наименование} & 
			\textbf{Размер} &
			\textbf{ Соотн. сторон} & 
			\textbf{Кол-во пикселей} \\ 
			\hline \endhead
