...
\begin{tikzpicture}
	...
	\draw (b)
	node[lnk, below left, align=right] {+/элемент\\\{union, readOnly,\\subsets вложенный\}} 
...
%	\draw node[ref] {Рис. \ref{fig:UMLroot}};
	...
	\class[below = 2.6cm of cSDoc]{\itshape СтруктурированныйДокумент}(cStrDoc){\hspace*{1ex}}{}
	...
	\draw [base-] (cDoc2) -- (cSDoc);
	
	%наследование Элемент-Фрагмент
	\draw [base-] (cEl2) -- (cEl2 |- сFrag.south);
	...
	node [lnk, pos=1, align=right, below left] {+/содЭлемент\\\{unon, readOnly,\\subsets элемент\}}
	...
	(b)
	node[lnk,below right, align=left] {+/подчасть\\\{union, readOnly,\\subsets вложенный\}}
	...
	node [lnk, pos=1, below left, align=right] {+часть\\\{subsets элемент\}}
	...
	\draw 
		(a)
		node[lnk, below right, align=left]{+часть\\\{subsets базовый\}}
...
\begin{tikzpicture}
	...
	node[lnk,pos=1, below right, align=left] {+рисунок\\\{subsets базовый\}}
