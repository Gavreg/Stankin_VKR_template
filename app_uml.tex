...
\begin{tikzpicture}
	...
	\class[right = 4cm of cSDoc.north east, below right, text width=4cm ] {\itshape Фрагмент}(cContEl){\hspace*{1ex}}{}
	...
	%класс Документ
	\class[above = of cStrDoc]{\itshape Документ}(cDoc){}{}
	\draw node[ref] {Рис. \ref{fig:UMLroot}};
	
	%Наследование Документ-СтруктурированныйДоукмент
	\draw[-base] (cStrDoc) -- (cDoc);
	...
	\steplineH[ocompnav-onav]{cPart.east}{cContEl.east}{3cm}
	\draw 
		(a)
		node[lnk, below right, align=left]{\{union, readOnly,\\subsets базовый\}\\+/часть}
		node[lnk, above right, align=left]{\quad1}
		(b)
		node[lnk, above right, align=left]{\{union, readOnly,\\subsets вложенный\}\\+/содЭлемент}
