...
\DeclareCaptionLabelSeparator{dot_tbl}{.\\}            
 ...
 %Подпись рис. центр
\captionsetup[figure]{justification=centering,labelsep=dot, format=plain, font={onehalfspacing},skip=0ex, belowskip=-2ex,}                       

%Подпись табл. справа
\captionsetup[table]{justification=raggedleft,labelsep=dot_tbl, format=plain, singlelinecheck=false,font={onehalfspacing},belowskip=1ex} 

%Подпись табл. справа
\captionsetup[listing]{justification=raggedleft,labelsep=dot, format=plain, position=above, singlelinecheck=false,belowskip=2 ex, skip=-1ex } 
