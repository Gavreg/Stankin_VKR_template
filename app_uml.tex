...
\begin{tikzpicture}
	...
	\class[above = 2cm of cDoc, text width = 4cm]{\itshape КомплектДокументов}(cDocPack){\null}{}
...
\begin{tikzpicture}
	...
	\class[right = 4cm of cSDoc.north east, below right, text width=4cm ] {\itshape Фрагмент}(cContEl){\null}{}
